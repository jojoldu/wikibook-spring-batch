...
@SpringBatchTest
@SpringBootTest(classes = {NonAsyncItemProcessorStepJobConfig.class, TestBatchConfig.class})
@TestPropertySource(properties = {"job.name=" + NonAsyncItemProcessorStepJobConfig.JOB_NAME})
class NonAsyncItemProcessorStepJobConfigTest {
    ...
    @Test
    void test_nonAsyncItemProcessorStep() throws Exception {
        //given
